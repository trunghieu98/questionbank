        ...
        return (
          ...
          <div className="navbar-header">
            <button type="button" className="navbar-toggle" data-toggle="collapse" data-target=".navbar-ex1-collapse">
              ...
              <Link to="/student" className="navbar-brand"> <i className="fas fa-home" /> Hệ Thống Quản Lý Đề Thi </Link>
          </div>
          ...
          <div className="collapse navbar-collapse navbar-ex1-collapse">
            <ul className="nav navbar-nav navbar-right navbar-color">
              ...
              <li className="dropdown">
                <a href="# " className="dropdown-toggle color" data-toggle="dropdown">Sinh Viên<b className="caret" /></a>
